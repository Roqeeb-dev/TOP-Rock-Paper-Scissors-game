...
function playRound() {
    ...
    if (humanChoice === computerChoice) {
        console.log(`There is a tie! ${humanChoice} is the same as ${computerChoice}`);
    } else if (
...
function playGame() {
    ...
    if (humanScore === 5) {
        console.log(`You won the game by a margin of ${humanScore} to ${computerScore}`);
    } else {
        console.log(`You lost the game by a margin of ${computerScore} to ${humanScore}`);
    }
}
